            ...
            <div class="log">
                <div class="log_wrap">
                    ...
                    <div class="line">
                        ...
                        <form id="log_1" name="idlogin" method="post" action="drloginPro.do" onsubmit="return logincheck()">
                            <input class="log_size" type="text" name="id" maxlength="15" autofocus="autofocus" placeholder="아이디"><br>
                            <input class="log_size" type="password" name="passwd" maxlength="15" placeholder="비밀번호"><br>
