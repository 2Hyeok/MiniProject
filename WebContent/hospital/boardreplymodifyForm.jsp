...
<script>
	...
	function popupClose(form) {
		...
		if(opener != null) {
			opener.boardreplymodifyForm = null;
...
<body>
	<div class="re_form_re">
		<form class="re_form_form" name="idcheckform" method="post"
			action="boardreplymodifyView.do" onsubmit="return idcheck()" target="board.do">
