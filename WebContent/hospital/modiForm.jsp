...
<body>
	<div class="re_form_re">
		<form class="re_form_form" name="passwdform" method="post"
			action="modiView.do" onsubmit="return passwdcheck()" target="hospital.do">
			<div>
				<div class="box1">
					<p>비밀번호 입력</p>
				...
				<div>
					<div>
						<input class="inputbutton1" type="submit" value="수정하기" onclick="window.close()"> 
