...
<script>
	...
	function popupClose(form) {
		...
		if(opener != null) {
			opener.boardreplydeleteForm = null;
...
<body>
	...
	<form class="re_form_form" name="passwdform" method="post" action="boardreplydeletePro.do" onsubmit="return passwdcheck()" target="board.do">
