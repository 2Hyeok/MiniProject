					...
					<article>
						<div class="form_box">
							...
							<form name="boardmodifyform" method="post"
								action="boardmodifyPro.do" onsubmit="return boardmodifycheck()">
								<input type="hidden" name="b_no" value="${b_no}"> 
								<input type="hidden" name="pageNum" value="${pageNum}"> 
								<input class="input_field" type="text" value="${memId}" name="fk_user_id1" readonly><br> 
								<input class="input_field" type="text" value="${bto.b_title}" name="b_title" autofocus maxlength="50"><br>
								<textarea class="textarea_field" name="b_write" maxlength="500" style="resize:none;">${fn:replace(bto.b_write, replaceChar,"<br />")}</textarea>
								<br> 
								<input class="inputbutton" type="submit" value="수정">
								<input class="inputbutton" type="reset" value="다시"> 
								<input class="inputbutton" type="button" value="수정 취소" onclick="location='board.do?pageNum=${pageNum}'">
							</form>
						</div>
					</article>
				</section>
