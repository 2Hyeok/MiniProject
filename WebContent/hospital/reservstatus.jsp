			...
			<div class="body">
				...
				<div class="rebox">
					<div style="text-align: center;">
						<div>
							<span style="font-size: 60px;">예약 현황 확인하기</span>
						</div>
					</div>
					<br>
					<br>
					<div style="text-align: center;">
						<div style="display: flex;">
							<div>
								<span style="font-size: 40px;"> 내과 </span>
								...
								<table class="reservtbl" style="text-align: center;">
									...
									<c:forEach var="row" items="${select3}">
										<tr>
											<td>${row.re_num}</td>
											<td>${row.user_id}</td>
											<td>${row.user_name}</td>
							...
							<div>
								<span style="font-size: 40px;"> 이비인후과</span>
								...
								<table class="reservtbl" style="text-align: center;">
									...
									<c:forEach var="row" items="${select4}">
										<tr>
											<td>${row.re_num}</td>
											<td>${row.user_id}</td>
											<td>${row.user_name}</td>
